...
Max Takeoff Weight (MTOW),"2,400 lbs","1,088.6 kg",POH Fig 6-7 2  
Max Landing Weight (MLW),"2,400 lbs","1,088.6 kg",POH Fig 5-11 3  
...
#### Normal Category (Max 2,400 lbs)

* **Aft Limit:** **47.3 inches** (1,201.4 mm) at all weights.  
* **Forward Limit:**  
* **Weight ≤ 1,950 lbs:** **35.0 inches** (889 mm).  
* **Weight \> 1,950 lbs:** Linearly increases to **39.5 inches** at 2,400 lbs.

**Forward Limit Formula (Normal Category):**For $Weight \> 1,950$:$$MinCG \= 35.0 \+ \\frac{(Weight \- 1950\) \\times (39.5 \- 35.0)}{(2400 \- 1950)}$$$$MinCG (in) \= 35.0 \+ 0.01 \\times (Weight \- 1950)$$
...
MTOW,"\> 2,400 lbs",ERROR,Exceeds Structural Limit 4  
Landing Weight,"\> 2,400 lbs",ERROR,Exceeds Structural Limit 3  
...
* **Weight Check:** The Calculated Takeoff Weight (**2,678.8 lbs**) is **HIGHER** than the MTOW (**2,400 lbs**).  
* **RESULT: OVERWEIGHT (ERROR)**  
* *Analysis:* VH-KXW is significantly heavier (+278.8 lbs) than the POH sample airplane (1467 lbs). It cannot carry full fuel and 4 adults legally.  
* **CG Check:** At 2,678 lbs (hypothetically), the limits are extrapolated, but physically the Aft Limit is 47.3".  
...
* *Useful Load:* $2400 \- 1745.8 \= 654.2 \\text{ lbs}$.  
* With Full Fuel (240 lbs), remaining payload for people/bags is **414.2 lbs**.  
* *Practical Load:* Pilot (170) \+ Passenger (170) \+ Bags (74) \+ Full Fuel \= 2400 lbs.
